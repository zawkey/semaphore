...
const MessageItem = React.memo(({ commitHash, imageVersion, extraTags, timestamp, date, needApproval, approved = false }) => {
  ...
  return (
    <div className={`run-item flex items-start mv1 pa2 bt`}>
      <button 
      ...
      <div className='w-full'>
        <div className={`flex justify-between w-ful`}>
          ...
          <span className="material-symbols-outlined fill light-gray f1 mr1">schedule</span>

          <span className="material-symbols-outlined fill orange f1 mr1">input</span>
          {isExpanded && <span className="f5 mr1 ttu">inputs</span>}
          <div className={`flex items-center pt1 ${isExpanded ? "hidden" : "flex"}`}>
            <span className="bg-black-05 text-gray-600 text-xs px-1 py-1 br2 mr2 pipeline-badge code hidden">code: {commitHash}</span>
          ...
          {isExpanded && (
            <div className="pt2">
              ...
              <div className="flex justify-between">
                <div className='w-1/2'>
                  <div className="flex items-start"> 
                    <i className="material-symbols-outlined mr1 text-sm hidden">input</i>
                    <div className="text-sm ml5">
                    <div className='mb1 ttu hidden'>Inputs</div>
