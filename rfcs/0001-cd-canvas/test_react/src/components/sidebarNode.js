...
const SidebarNode = ({
  ...
  <div className="cursor-grab rounded-md flex items-center node pl2 pr2 py-3 relative bg-gray-100 hover:bg-gray-200 mb-2" onDragStart={(e) => onDragStart(e, 'githubIntegration')} draggable="true">
      ...
      {logo && (
        <img src={logo} className="sidebar-node-icon mr-2" width="16px"/>
      )}
    ...
    <div className=" flex items-center icons group/item">
        <button className="invisible group-hover/item:visible add-node material-symbols-outlined f3 gray mr2 hover:bg-gray-100 br2" onClick={() => onAddNode('githubIntegration', { x: 0, y: 0 })}>add</button>
