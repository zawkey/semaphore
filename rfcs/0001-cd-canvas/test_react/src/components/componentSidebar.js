            ...
            <div className="flex flex-col w-full h-full items-start py-0 relative flex-[0_0_auto] border-r [border-right-style:solid] border-[#0000001a]">
              ...
              <div className="flex min-h-0 flex-1 flex-col overflow-auto">
                <div className="relative flex w-full min-w-0 flex-col px-4">
                  <div className="relative w-fit whitespace-nowrap text-sm b gray">
                    Events
                  </div>
                  {/* Nodes Section */}
                  <div className="node-group cursor-pointer mb-2 category-trigger flex items-center justify-between relative self-stretch w-full flex-[0_0_auto]" onClick={handleNodesToggle}>
